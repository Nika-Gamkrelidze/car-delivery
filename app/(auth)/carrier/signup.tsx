          ...
          <Container style={[styles.card, { backgroundColor: cardBackground }]}>
            ...
            <View style={styles.header}>
              <View style={styles.iconContainer}>
                <Ionicons name="car" size={48} color={Palette.blue[600]} />
              </View>
              <ThemedText type="title" style={styles.title}>
                Join as Carrier
              </ThemedText>
              <ThemedText style={styles.subtitle}>Start delivering vehicles today</ThemedText>
            </View>
            ...
            <View style={styles.form}>
              ...
              {/* Submit Button */}
              <Button title="Create carrier account" onPress={onSubmit} loading={submitting} disabled={submitting} size="lg" />
